...
import icon_panther from '../assets/panther.png';
...
function Notification() {
  ...
  function newNotification(message) {
    ...
    switch (type) {
      ...
      default:
        return {
          img: icon_wins95,
          text1: 'Bem-vindo a 1995!  :D',
          text2: 'Você está em um site desenvolvido por: ',
          extraImg: icon_panther,
          function: '',
        };
    }
  }
  ...
  {notificationData.extraImg && (
    <img
      src={notificationData.extraImg}
      alt="extra"
      className="noti_extra_img"
    />
  )}
</div>
        </motion.div>
