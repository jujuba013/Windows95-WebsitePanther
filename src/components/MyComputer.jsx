...
import matrix from '../assets/pc-sticker.png'
...
function MyComputer() {
  ...
  <div  style={{
   display: 'flex',
    ...
    height: '100%',
    textAlign: 'center',
    gap: '2rem', // espaçamento entre texto e GIF
    padding: '1rem',
}} >
    <h2>Panther New Retrowave</h2>
    <p>Confira minhas artes na pasta "Resume"</p>
    <img src={matrix}   style={{ 
            width: '30vw',      // 50% da largura da janela
            height: 'auto',     // mantém proporção
            maxWidth: '90%',    // nunca ultrapassa 90% da largura
            maxHeight: '70vh',  // nunca ultrapassa 70% da altura da janela
            objectFit: 'contain'
        }}  />
  </div>
)}
