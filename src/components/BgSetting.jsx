...
import eff7 from '../assets/matrix.gif'
import eff8 from '../assets/matrix3.gif'
import eff9 from '../assets/matrix-neo.gif'
  ...
  const { 
    ...
    deleteTap,
      ...
      const colorOptions = [
        ...
        { value: 13, label: 'Escolha sua cor favorita!', color: userPickedColor, image: userPickedColor, barColor: userPickedColor},
        { value: 15, label: 'Retrowave', color: '#0510F5', image: eff7, barColor: '#0510F5'},
        { value: 16, label: 'Retrowave 2', color: '#000000', image: eff8, barColor: '#000000'},
        { value:17, label: 'Nois ae', color: '#149104', image: eff9, barColor: '#149104'}
      ];
